    ...
    return (
      <main className="min-h-screen text-neutral-900">
        <section className="container mx-auto px-6 py-20 text-center">
          <h2 className="text-4xl font-bold mb-6 text-primary-600">Contact {author.name}</h2>
          <p className="max-w-xl mx-auto text-neutral-700 mb-8">
          ...
          <form className="max-w-md mx-auto bg-white shadow p-8 rounded-xl space-y-4">
            ...
            <button type="submit" className="w-full bg-primary-600 text-white py-3 rounded-xl hover:bg-primary-700 transition">
              Send Message
            </button>
          </form>
        </section>
